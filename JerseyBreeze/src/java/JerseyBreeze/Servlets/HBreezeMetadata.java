    ...
    public class HBreezeMetadata
    {
        ...
        void AddClass(ClassMetadata meta)
        {
           Class<?> type = meta.getMappedClass(EntityMode.POJO);
            ...
            cmap.put("shortName", type.getName());
        ...
        void AddClassProperties(ClassMetadata meta, PersistentClass pClass, List<Map<String, Object>> dataList, List<Map<String, Object>> navList)
        {
        ...
        /// <returns></returns>
        private Map<String, Object> MakeAssociationProperty(Type containingType, AssociationType propType, String propName, String columnNames, PersistentClass pClass, Dictionary<String, Dictionary<String, Object>> relatedDataPropertyMap, boolean isKey)
        {
            ...
            if (!propType.isCollectionType())
            {
                ...
                Dictionary<String, Object> relatedDataProperty = relatedDataPropertyMap.get(columnNames);
        ...
        /// <returns></returns>
        Class<?> GetEntityType(Class<?> type, boolean isCollectionType)
        {
            if (!isCollectionType)
            {
                return type;
        ...
        private const String ONE2ONE = "_1to1";
        private const String ASSN = "AN_";
